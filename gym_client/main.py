...
def main():
    ...
    parser.add_argument('--minibatch_length', type=int, default=20)
    parser.add_argument('--epochs', type=int, default=4)
    parser.add_argument('--discount_factor', type=float, default=0.92)
    parser.add_argument('--gae', type=float, default=0.92)
