...
CreateProgramScreenState Tabs::update()
{
    ...
    ImGui::TabButton("Body", &selected_number, static_cast<int>(CreateProgramScreenState::Body));
    ImGui::SameLine();
    ImGui::TabButton("Algorithm", &selected_number, static_cast<int>(CreateProgramScreenState::Algorithm));
    ImGui::SameLine();
    ImGui::TabButton("Rewards", &selected_number, static_cast<int>(CreateProgramScreenState::Rewards));
    ImGui::SameLine();
    ImGui::TabButton("Brain", &selected_number, static_cast<int>(CreateProgramScreenState::Brain));
    ImGui::SameLine();
    ImGui::TabButton("Save/Load", &selected_number, static_cast<int>(CreateProgramScreenState::SaveLoad));
    ImGui::End();
    ImGui::PopFont();
    ImGui::PopStyleVar();
